                    ...
                    <div class="card-body p-0">
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-flex">
                                <div class="flex-grow-1 bg-login-image" style="background-image: url(&quot;assets/img/31154317_1703477709717471_8175937003506892800_n.jpg&quot;);"></div>
                            </div>
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user" method="post" action="account/kibebe_user.php">
                                        <div class="form-group"><input class="form-control form-control-user" type="number" id="phone_number" aria-describedby="emailHelp" placeholder="Enter phone number..." name="phone_number" required="" minlength="10"></div>
                                        <div class="form-group"><input class="form-control form-control-user" type="password" id="password" placeholder="Password" name="password" minlenght="6" required=""></div>
